...
from .views.booking import Booking, FutsalBooking, all_booking, add_booking, delete_booking, update_booking, sendmail
...
urlpatterns = [
    ...
    path('bookings', auth_middleware(all_booking), name='bookings'),
